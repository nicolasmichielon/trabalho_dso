...
class Morador(Pessoa):
    ...
    def criar_ocorrencia(self, descricao: str, sindico: Sindico, moradores: list, registro: RegistroOcorrencias, tipo_de_ocorrencia:TipoOcorrencia, resolvida: bool = False):
